...
curl -kL "https://www.is.uestc.edu.cn/" 2>&- | pup 'li.annce-cont:first-of-type li json{}' | jq -r '.[].children[0] as $li | "
<entry>
...
</entry>"' | sed 's;<link href=";<link href="https://www.is.uestc.edu.cn/;' | sed "s;<published>;<published>${year}-;"
